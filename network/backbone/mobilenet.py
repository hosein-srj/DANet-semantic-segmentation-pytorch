...
def mobilenetv3_large(pretrained=True, **kwargs):
    ...
    if pretrained:
        # model.load_state_dict(torch.load('F:/PycharmProject/untitled/data/checkpoints/mobilenetv3-large-1cd25616.pth'))
        model.load_state_dict(torch.load('./mobilenetv3-large-1cd25616.pth'))
        print("MobileNetV3 PreTrained!!!")
    return model


def mobilenetv3_small(pretrained=True, **kwargs):
    """
